...
export default function UserInfoUpdateModal({
  ...
  const userInfoUpdateAxios = async () => {
    try {
      ...
      refetch();
      setUserInfoUpdateModalFlag(false);
    } catch (err) {
      console.log(err);
    }
  };
  ...
  return (
    <div className="fixed z-10 top-0 w-[100vw] h-[100vh] flex items-center justify-center">
      <div className="fixed w-[100vw] h-[100vh] bg-black opacity-50"></div>
      <div className="z-20 flex flex-col justify-center items-center h-[90vh] w-[28rem] inset-0 bg-white rounded-xl">
        <div className="flex flex-row items-center justify-between w-[85%]">
          <div className="text-[1.8rem] font-semibold">정보 수정</div>
          <div
        ...
        <div className="flex flex-col w-[85%]">
          <div className="ml-[0.2rem]">백준 아이디</div>
          <input
            className="w-[100%] h-[2.8rem] border rounded-lg pl-[0.5rem] outline-none"
            onChange={(e) => {
        ...
        <Gap hSize="0.5rem" />
        <div className="flex flex-col w-[85%]">
          <div className="ml-[0.2rem]">한줄소개</div>
          <input
            className="w-[100%] h-[2.8rem] border rounded-lg pl-[0.5rem] outline-none"
            onChange={(e) => {
        ...
        <div className="flex flex-row w-[85%]">
          <div className="text-[1.3rem] font-medium">SNS</div>
        </div>
        <Gap hSize="0.5rem" />
        <div className="flex flex-col w-[85%]">
          <div className="ml-[0.2rem]">이메일</div>
          <div className="flex flex-row items-center w-[100%] h-[2.8rem] border rounded-lg  pl-[0.5rem]">
            <EmailIcon />
            <Gap wSize="0.5rem" />
        ...
        <Gap hSize="0.5rem" />
        <div className="flex flex-col w-[85%]">
          <div className="ml-[0.2rem]">깃허브</div>
          <div className="flex flex-row items-center w-[100%] h-[2.8rem] border rounded-lg  pl-[0.5rem]">
            <GithubIcon />
            <Gap wSize="0.5rem" />
            <input className="outline-none"></input>
        ...
        <Gap hSize="0.5rem" />
        <div className="flex flex-col w-[85%]">
          <div className="ml-[0.2rem]">링크드인</div>
          <div className="flex flex-row items-center w-[100%] h-[2.8rem] border rounded-lg  pl-[0.5rem]">
            <LinkedinIcon />
            <Gap wSize="0.5rem" />
            <input className="outline-none"></input>
        ...
        <Gap hSize="0.5rem" />
        <div className="flex flex-col w-[85%]">
          <div className="ml-[0.2rem]">티스토리</div>
          <div className="flex flex-row items-center w-[100%] h-[2.8rem] border rounded-lg  pl-[0.5rem]">
            <TistoryIcon />
            <Gap wSize="0.5rem" />
            <input className="outline-none"></input>
        ...
        <Gap hSize="2rem" />
        <button
          className="w-[85%] h-[3rem] items-center bg-gray-300 text-gray-500 rounded"
          onClick={userInfoUpdateAxios}
        >
          저장
        </button>
      </div>
